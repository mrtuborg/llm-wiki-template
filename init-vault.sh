...
echo "═══════════════════════════════════════════════"
echo "  Next steps:"
echo "  1. Edit vault.config.yaml — set your domains"
echo "  2. Add sources: ./llm-wiki source add /path/to/raw"
echo "  3. Process:     ./llm-wiki add"
echo "  4. Search:      ./llm-wiki search 'query'"
echo "═══════════════════════════════════════════════"
